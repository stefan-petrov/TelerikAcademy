...
namespace AcademyEcosystem
{
    ...
    class Boar : Animal, IHerbivore, ICarnivore
    {
        ...
        {
            if (animal is IHerbivore || animal is ICarnivore)
            {
                if (animal.Size <= this.Size)
                {
                    animal.GetMeatFromKillQuantity();
                    return animal.Size;
                }
            }
            else if (animal is Zombie)
            {
                return 10;
            }
